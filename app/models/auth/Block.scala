...
class Block {
  ...
  private[this] var _assignments: java.util.Set[Object] = _
  def assignments: List[Object] = _assignments.asScala.toList
  def assignments_=(theAssignments: List[Object]) = {
